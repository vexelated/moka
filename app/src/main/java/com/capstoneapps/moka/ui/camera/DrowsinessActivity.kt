...
import com.capstoneapps.moka.databinding.ActivityDrowsinessBinding
...
class DrowsinessActivity : AppCompatActivity() {
    ...
    private lateinit var drowsinessClassifierHelper: DrowsinessClassifierHelper
    ...
    private fun startCamera() {
        ...
        drowsinessClassifierHelper =
            DrowsinessClassifierHelper(
                context = this,
                drowsinessClassifierListener = object : DrowsinessClassifierHelper.ClassifierListener {
                    override fun onError(error: String) {
                        runOnUiThread {
                            Toast.makeText(this@DrowsinessActivity, error, Toast.LENGTH_SHORT).show()
                        }
                    }
                ...
                ImageAnalysis.Builder()
                    ...
                    .also {
                        it.setAnalyzer(Executors.newSingleThreadExecutor()) { image ->
                            drowsinessClassifierHelper.classify(image)
                        }
                    }
            try {
